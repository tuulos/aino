...
extern int LANG_EN_stem(struct SN_env * z);
...
extern void LANG_EN_close_env(struct SN_env * z);
...
extern struct SN_env * LANG_EN_create_env(void) { return SN_create_env(0, 2, 1); }

extern void LANG_EN_close_env(struct SN_env * z) { SN_close_env(z); }
