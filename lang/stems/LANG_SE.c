...
extern int LANG_SE_stem(struct SN_env * z);
...
extern void LANG_SE_close_env(struct SN_env * z);
...
extern struct SN_env * LANG_SE_create_env(void) { return SN_create_env(0, 1, 0); }

extern void LANG_SE_close_env(struct SN_env * z) { SN_close_env(z); }
